...
def main():
    ...
    deposit = slow_type('𝓔𝓪𝓬𝓱  𝓬𝓾𝓼𝓽𝓸𝓶𝓮𝓻 𝔀𝓲𝓵𝓵  𝓱𝓪𝓿𝓮  𝓽𝓸  𝓹𝓪𝔂 𝓪 𝓭𝓮𝓹𝓸𝓼𝓲𝓽 𝓸𝓯 $5 𝓯𝓸𝓻 𝓮𝓪𝓬𝓱 𝓼𝓪𝓵𝓮')
    method = slow_type('𝓘𝓼 𝓽𝓱𝓲𝓼 𝓶𝓮𝓽𝓱𝓸𝓭 𝓸𝓴𝓪𝔂 𝔀𝓲𝓽𝓱 𝔂𝓸𝓾?(𝓨 \ 𝓝 )')
    if method == 'y':
        ...
        return None
    prices = ['::::\t1.𝓜𝓪𝓻𝓭𝓲 𝓖𝓻𝓪𝓼 𝓜𝓪𝓼𝓴𝓼 $3.50','::::\t2.𝓞𝓾𝓽𝓭𝓸𝓸𝓻 𝓦𝓸𝓸𝓭𝓮𝓷 𝓓𝓪𝓷𝓬𝓮 𝓕𝓵𝓸𝓸𝓻 $50.00', '::::\t3.𝓒𝓪𝓷 𝓵𝓲𝓰𝓱𝓽𝓼 $2.50','::::\t4.𝓜𝓪𝓻𝓭𝓲 𝓖𝓻𝓪𝓼 𝓢𝓽𝓻𝓮𝓮𝓽𝓼 𝓢𝓲𝓰𝓷𝓼 $5.00', '::::\t5.𝓑𝓾𝓲𝓵𝓭𝓲𝓷𝓰 𝓟𝓻𝓸𝓹𝓼 $25.00']
    print(*prices,sep='\n')
    purchase = slow_type('\n 𝓣𝓸 𝓶𝓪𝓴𝓮 𝓪 𝓼𝓮𝓵𝓮𝓬𝓽𝓲𝓸𝓷 𝓽𝔂𝓹𝓮 𝓲𝓷 𝓽𝓱𝓮 𝓷𝓾𝓶𝓫𝓮𝓻 𝓵𝓲𝓼𝓽𝓮𝓭 𝓫𝔂 𝓽𝓱𝓮 𝓲𝓽𝓮𝓶. \n')
    purchase = float(slow_type('\n 𝓔𝓷𝓽𝓮𝓻 𝓽𝓱𝓮 𝓹𝓻𝓲𝓬𝓮 𝓸𝓯 𝓽𝓱𝓮 𝓹𝓾𝓻𝓬𝓱𝓪𝓼𝓮: \n'))
    ...
    core.shopping_inven()
    core.calculate_totals(purchase)
